...
def test_loads_repo_config():
    ...
    assert cfg.risk.account_risk_per_trade_percent == 1.5
    ...
    assert cfg.entry.pre_breakout.compression_position_fraction == 0.35
    assert cfg.entry.pre_breakout.no_compression_position_fraction == 0.25
    ...
    assert cfg.entry.breakout_confirm.position_fraction == 0.45
    assert cfg.entry.retest_confirm.position_fraction == 0.55
    ...
    assert cfg.risk.retest_max_leverage == 8
